...
exports.run = (client, message) => {
	...
	const embed = new Discord.RichEmbed()
		.setColor(0xFF0000)
		.setTitle('RESPECT YOUR ELDERS (LEFFEN DISS TRACK)')
		.setURL('https://www.youtube.com/watch?v=KhsOW-_TwfU')
		.setThumbnail('https://i.imgur.com/S6FUMtl.png')
		.setDescription(`[Verse 1: Chillindude829]
	...
	[Verse 3: Chillindude829]
		...
		.setFooter('NSFL: https://www.youtube.com/watch?v=7i0PUCX7VEw');
...
exports.help = {
	name: 'lawful',
	description: 'Make this pussy stop talkin',
	usage: '[lawful]'
};